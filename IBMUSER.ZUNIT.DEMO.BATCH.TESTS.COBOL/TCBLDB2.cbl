      ...
      *| DATE GENERATED: 12/05/2023 12:50                              |
      *| ID: b7415568-1031-4ac9-a442-7ccdd7c14b69                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| ZUNIT TEST_TEST2                                              |
      ...
      *+---------------------------------------------------------------+
       ...
       01 PROGRAM-NAME   PIC X(8)  VALUE 'CBLDB2'.
       01 BZ-ASSERT.
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * SET INPUT VALUE
           ENTRY "PGM_INPT_CBLDB2" USING AZ-TEST AZ-INFO-BLOCK
           .
           DISPLAY 'AZU0000I PGM_INPT_CBLDB2 INPUT VALUES...'.
           MOVE 0 TO RETURN-CODE.
           ...
           PERFORM TEARDOWN.
      * EVALUATE OUTPUT VALUE
           ENTRY "PGM_OUTP_CBLDB2" USING AZ-TEST AZ-INFO-BLOCK
           .
           DISPLAY 'AZU0000I PGM_OUTP_CBLDB2 CHECK VALUES...'.
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE 'b7415568-1031-4ac9-a442-7ccdd7c14b69'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * QSAM_INPT_WRIT_CBLDB2.
           ENTRY 'QSAM_INPT_WRIT_CBLDB2' USING AZ-TEST
             AZ-INFO-BLOCK AZ-INFO-DDNM AZ-INFO-STAT AZ-INFO-COND
             AZ-ACMDVA AZ-PARM.
           DISPLAY 'AZU0000I QSAM_INPT_WRIT_CBLDB2 CHECK VALUES...'
      ...
      *    FILE "OUTFILE"" (DD:DDOUTPUT)"
       ...
       WRITE-INPUT.
           EXIT.
       TEARDOWN.
           DISPLAY 'AZU0000I FILE_CBLDB2 END.'
           GOBACK.
       END PROGRAM 'FILE_CBLDB2'.
      *+---------------------------------------------------------------+
      ...
      *+---------------------------------------------------------------+
       IDENTIFICATION DIVISION.
       PROGRAM-ID. 'QSAM_OUTFILE_CBLDB2'.
       DATA DIVISION.
       WORKING-STORAGE SECTION.
       01 BZ-ASSERT.
         03 MESSAGE-LEN PIC S9(4) COMP-4 VALUE 24.
      ...
      * SET AREA ADDRESS TO POINTER
           ...
           PERFORM TEARDOWN.
       TEARDOWN.
      *     DISPLAY 'AZU0000I QSAM_OUTFILE_CBLDB2 END.'
           GOBACK.
       P-OUTPUT-TEST2.
       ...
       P-INPUT-TEST2.
           ...
           END-IF.
           EXIT.
       END PROGRAM 'QSAM_OUTFILE_CBLDB2'.
      *+---------------------------------------------------------------+
      *| ZUNIT GTMEMRC                                                 |
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * DB2_INPT_0003_CBLDB2.
           ENTRY 'DB2_INPT_0003_CBLDB2' USING AZ-TEST
           AZ-INFO-BLOCK AZ-APLIST .
           DISPLAY 'AZU0000I DB2_0003_CBLDB2 CHECK VALUES...'
           MOVE 4 TO RETURN-CODE.
      ...
      * EXEC SQL OPEN : OUT=0 IN=0
           ...
           PERFORM TEARDOWN.
      * SET INPUT VALUE
      * DB2_OUTP_0003_CBLDB2.
           ENTRY 'DB2_OUTP_0003_CBLDB2' USING AZ-TEST
           AZ-INFO-BLOCK AZ-APLIST .
           DISPLAY 'AZU0000I DB2_0003_CBLDB2 INPUT VALUES...'
           MOVE 0 TO RETURN-CODE.
           MOVE SQL-STMT-NUM OF AZ-APLIST TO AZ-STMT-NUM
           SET ADDRESS OF AZ-SQLDA TO SQL-VPARMPTR
           MOVE SQLDA-NUM OF AZ-SQLDA TO AZ-OUT-PARM-NUM
      ...
      * EXEC SQL OPEN : OUT=0 IN=0
           ...
           PERFORM TEARDOWN.
       TEARDOWN.
           DISPLAY 'AZU0000I DB2_0003_CBLDB2 END.'
           GOBACK.
       END PROGRAM 'DB2_0003_CBLDB2'.
      *+---------------------------------------------------------------+
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * DB2_INPT_0005_CBLDB2.
           ENTRY 'DB2_INPT_0005_CBLDB2' USING AZ-TEST
           AZ-INFO-BLOCK AZ-APLIST .
           DISPLAY 'AZU0000I DB2_0005_CBLDB2 CHECK VALUES...'
           MOVE 4 TO RETURN-CODE.
           MOVE SQL-STMT-NUM OF AZ-APLIST TO AZ-STMT-NUM
           SET ADDRESS OF AZ-SQLDA TO SQL-VPARMPTR
           MOVE SQLDA-NUM OF AZ-SQLDA TO AZ-OUT-PARM-NUM
      ...
      * EXEC SQL CLOSE : OUT=0 IN=0
           ...
           PERFORM TEARDOWN.
      * SET INPUT VALUE
      * DB2_OUTP_0005_CBLDB2.
           ENTRY 'DB2_OUTP_0005_CBLDB2' USING AZ-TEST
           AZ-INFO-BLOCK AZ-APLIST .
           DISPLAY 'AZU0000I DB2_0005_CBLDB2 INPUT VALUES...'
           MOVE 0 TO RETURN-CODE.
           MOVE SQL-STMT-NUM OF AZ-APLIST TO AZ-STMT-NUM
           SET ADDRESS OF AZ-SQLDA TO SQL-VPARMPTR
           MOVE SQLDA-NUM OF AZ-SQLDA TO AZ-OUT-PARM-NUM
      ...
      * EXEC SQL CLOSE : OUT=0 IN=0
           ...
           PERFORM TEARDOWN.
       TEARDOWN.
           DISPLAY 'AZU0000I DB2_0005_CBLDB2 END.'
           GOBACK.
       END PROGRAM 'DB2_0005_CBLDB2'.
      *+---------------------------------------------------------------+
      ...
      *+---------------------------------------------------------------+
       ...
       PROCEDURE DIVISION.
      * CHECK OUTPUT VALUE
      * DB2_INPT_0004_CBLDB2.
           ENTRY 'DB2_INPT_0004_CBLDB2' USING AZ-TEST
           AZ-INFO-BLOCK AZ-APLIST .
           DISPLAY 'AZU0000I DB2_0004_CBLDB2 CHECK VALUES...'
           MOVE 4 TO RETURN-CODE.
           MOVE SQL-STMT-NUM OF AZ-APLIST TO AZ-STMT-NUM
           SET ADDRESS OF AZ-SQLDA TO SQL-VPARMPTR
           MOVE SQLDA-NUM OF AZ-SQLDA TO AZ-OUT-PARM-NUM
      ...
      * EXEC SQL FETCH : OUT=0 IN=1
           ...
           PERFORM TEARDOWN.
      * SET INPUT VALUE
      * DB2_OUTP_0004_CBLDB2.
           ENTRY 'DB2_OUTP_0004_CBLDB2' USING AZ-TEST
           AZ-INFO-BLOCK AZ-APLIST ARGI1.
           DISPLAY 'AZU0000I DB2_0004_CBLDB2 INPUT VALUES...'
           MOVE 0 TO RETURN-CODE.
           MOVE SQL-STMT-NUM OF AZ-APLIST TO AZ-STMT-NUM
           SET ADDRESS OF AZ-SQLDA TO SQL-VPARMPTR
           MOVE SQLDA-NUM OF AZ-SQLDA TO AZ-OUT-PARM-NUM
      ...
      * EXEC SQL FETCH : OUT=0 IN=1
           ...
           PERFORM TEARDOWN.
       TEARDOWN.
           DISPLAY 'AZU0000I DB2_0004_CBLDB2 END.'
           GOBACK.
       END PROGRAM 'DB2_0004_CBLDB2'.
