...
//        DSN=IBMUSER.ZUNIT.DEMO.LISTING(PGM02GB)
//COBOL.SYSDEBUG DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.SYSDEBUG(PGM02GB)
//COBOL.SYSLIN DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.OBJECT(PGM02GB)
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.COBOL(PGM02GB)
//*
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.LOAD(PGM02GB)
//*
