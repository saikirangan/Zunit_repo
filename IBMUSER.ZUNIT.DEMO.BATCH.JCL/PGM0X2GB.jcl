...
//        DSN=IBMUSER.ZUNIT.DEMO.LISTING(PGM0X2GB)
//COBOL.SYSDEBUG DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.SYSDEBUG(PGM0X2GB)
//COBOL.SYSLIN DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.OBJECT(PGM0X2GB)
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.COBOL(PGM0X2GB)
//*
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.LOAD(PGM0X2GB)
//*
