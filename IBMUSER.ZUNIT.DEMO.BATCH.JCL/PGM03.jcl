...
//        DSN=IBMUSER.ZUNIT.DEMO.LISTING(PGM03)
//COBOL.SYSDEBUG DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.SYSDEBUG(PGM03)
//COBOL.SYSLIN DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.OBJECT(PGM03)
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.COBOL(PGM03)
//*
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.LOAD(PGM03)
//*
