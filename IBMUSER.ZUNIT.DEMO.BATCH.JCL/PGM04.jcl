...
//        DSN=IBMUSER.ZUNIT.DEMO.LISTING(PGM04)
//COBOL.SYSDEBUG DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.SYSDEBUG(PGM04)
//COBOL.SYSLIN DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.OBJECT(PGM04)
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.COBOL(PGM04)
//*
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.LOAD(PGM04)
//*
