...
//        DSN=IBMUSER.ZUNIT.DEMO.LISTING(PGM01GB)
//COBOL.SYSDEBUG DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.SYSDEBUG(PGM01GB)
//COBOL.SYSLIN DD DISP=SHR,
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.OBJECT(PGM01GB)
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.COBOL(PGM01GB)
//*
...
//        DSN=IBMUSER.ZUNIT.DEMO.BATCH.LOAD(PGM01GB)
//*
